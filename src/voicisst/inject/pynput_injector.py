...
_ACCESSIBILITY_HINT = (
    "macOS is silently dropping Voicisst's synthetic keystrokes.\n"
    "Grant Accessibility permission to your terminal (or the Voicisst app) in\n"
    "System Settings -> Privacy & Security -> Accessibility, then restart Voicisst."
)

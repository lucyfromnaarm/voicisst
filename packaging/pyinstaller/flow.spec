# -*- mode: python -*-
"""PyInstaller spec for the standalone ``flow`` binary (onedir).

Build (with flow-dictation[local,server] + pyinstaller installed):

    pyinstaller --noconfirm packaging/pyinstaller/flow.spec

Output lands in dist/flow/ — run dist/flow/flow.
"""
